var de = {
    ...
    strings: {
        ...
        SHOW_OUTLINE: 'Zeige Umriss',
        HIDE_OUTLINE: 'Verstecke Umriss',
        SHOW_SETTINGS: 'Zeige Einstellungen',
        HIDE_SETTINGS: 'Verstecke Einstellungen',
        PAGE_OUTLINE: 'Seitenumriss',
        SETTINGS: 'Settings',
        CONTRAST: 'Kontrast',
        ...
        LINK_IDENTICAL_NAME: 'Der Link hat den gleichen Text wie ein anderer Link, obwohl er auf eine andere Seite verweist. Mehrere Links mit demselben Text können bei Personen, die Bildschirmlesegeräte verwenden, zu Verwirrung führen.<hr>Erwäge, den folgenden Link beschreibender zu gestalten, um ihn von anderen Links zu unterscheiden: <strong {r}>%(linkText)</strong>',
        ...
        LINK_IMAGE_BAD_ALT_MESSAGE: 'Dateierweiterung im Alt-Text gefunden. Achte darauf, dass der Alt-Text das Ziel des Links beschreibt und nicht eine wörtliche Beschreibung des Bildes ist. Entferne: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
        ...
        LINK_ALT_HAS_BAD_WORD_MESSAGE: 'Dateierweiterung im Alt-Text gefunden. Wenn das Bild eine Geschichte, eine Stimmung oder eine wichtige Information vermittelt - beschreibe das Bild unbedingt. Entferne: <strong {r}>%(error)</strong>.<hr><strong>Alt text:</strong> %(altText)',
        ...
        LINK_IMAGE_ARIA_HIDDEN: 'Der Link um das Bild hat <code>aria-hidden=&quot;true&quot;</code>, ist aber immer noch mit der Tastatur fokussierbar. Wenn Du einen redundanten oder doppelten Link ausblenden willst, füge <code>tabindex=&quot;-1&quot;</code> hinzu.',
        ...
        LABELS_ARIA_LABEL_INPUT_MESSAGE: 'Die Eingabe hat einen zugänglichen Namen, stelle bitte trotzdem sicher, dass es auch ein sichtbares Label gibt. <hr> Der zugängliche Name für diese Eingabe lautet: <strong>%(ariaLabel)</strong>',
        ...
        // Contrast
        CONTRAST_ERROR: 'Dieser Text hat nicht genügend Kontrast zum Hintergrund. Das Kontrastverhältnis sollte mindestens 4,5:1 für normalen Text und 3:1 für großen Text betragen. <hr> Das Kontrastverhältnis beträgt <strong {r}>%(cratio)</strong> für den folgenden Text: <strong {r}>%(nodetext)</strong>',
        CONTRAST_WARNING: 'Der Kontrast dieses Textes ist unbekannt und muss manuell überprüft werden. Stelle sicher, dass der Text und der Hintergrund einen starken Farbkontrast aufweisen. Das Kontrastverhältnis sollte mindestens 4,5:1 für normalen Text und 3:1 für großen Text betragen. <hr> <strong>Bitte überprüfen:</strong> %(nodetext)',
